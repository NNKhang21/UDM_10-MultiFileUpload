...
| # | Yêu cầu | Ý nghĩa |
|---|---|---|
| 5 | Quy tắc xử lý trùng tên | Ghi đè, từ chối, hoặc tự đổi tên, tuỳ cấu hình đã chọn |
...
| 12 |	Chặn tên thiết bị dành riêng của Windows | CON, PRN, AUX, NUL, COM1-9, LPT1-9 đều không nằm trong danh sách ký tự cấm nhưng vẫn bị hệ điều hành từ chối |
## Ghi chú
